...
public class TipoBean implements Serializable {
	...
	public String crearTipo() {
		...
		tipo="";
		descripcion="";
		System.out.println(arrayTipoLogin.length+"CALVO");
	...
	public String cargarTipo(Tipo u){
		...
		System.out.println(idTipo+tipo+descripcion+"Huevon");
	...
	public List<SelectItem> getListlibre(){
		...
		System.out.println(listado.size()+" libres");
		//System.out.println(delibres().size()+" libres");
			for(Actividad t:listado){
				SelectItem item=new SelectItem(t.getIdActividad(),t.getActividad());
				ls.add(item);
			}
				return ls;
	}
	...
	public List<SelectItem> getListocupado(){
		...
		System.out.println(ocupados.size()+" ocupados");
	...
	public String asignarActil(){
		...
		System.out.println("metodo asignar libre:"+add);
			return "";
		}
	...
	//metodo para asignar el Usuario al tipo
		public String asignarTipo(){
			...
			System.out.println("metodo asignar tipo:"+add);
				return "";
			}
	...
	public String asignarActiO(){
		...
		System.out.println("metodo asignar ocupado:"+del);
			return "";
		}
	...
	//metodo para mostrar los Actividades
		...
		public List<String> permisos(Tipo t){
			...
			for (Actividad a : la){
				for (Inter g: o){
					if (a.getIdActividad().equals(g.getActividad().getIdActividad())){
