...
public class SalasBean implements Serializable{
	...
	public String crearNuevoRecursoTipo(){
		...
		try {
			manager.insertarSala(getTiponom(), getDescripcion(),getImagen(),getCapacidad());
			tiponom="";
			imagen = "300.jpg";
			idcolor=0;
			capacidad=null;
	...
	public String modificarSala(){
		try {
			manager.editarSala(getIdRectipo(), getTiponom(), getDescripcion(), getImagen(),getIdcolor(),getCapacidad());
			setTiponom("");
			descripcion="";
			capacidad=null;
			imagen = "300.jpg";
	...
	public String cancelarModificacion(){
		setTiponom("");setIdRectipo(0);idcolor=null;setDescripcion("");setImagen("300.jpg");capacidad=null;
...
// metodo para comprobar el alias
	...
	// metodo para poner el nombre a la imagen
			...
			public String cambiarEstado(Sala r){
				try {
					FacesContext context = FacesContext.getCurrentInstance();
			        context.addMessage(null, new FacesMessage("INFORMACION",manager.cambioDisSala(r.getIdSala())));
