...
public class Tipoevento implements Serializable {
	...
	//bi-directional many-to-one association to Coloreve
	@ManyToOne
	@JoinColumn(name="idcoloreve")
	private Coloreve coloreve;
	...
	public Coloreve getColoreve() {
		return this.coloreve;
	}

	public void setColoreve(Coloreve coloreve) {
