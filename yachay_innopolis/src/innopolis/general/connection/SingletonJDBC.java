package innopolis.general.connection;
...
public class SingletonJDBC {
	...
	private static String URL = "jdbc:postgresql://localhost:5432/bd_inno";
	private static String USER = "u_inno";
	private static String PASS = ",ngo4uIoo2|e";
