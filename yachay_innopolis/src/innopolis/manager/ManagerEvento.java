...
public class ManagerEvento {
	...
	// ------Eventos-------
		...
		public void insertarEvento(String nombre, String descripcion/*,
				String lugar*/, String imagen, Timestamp fecha_inicio, Timestamp fecha_fin, float costo, Integer cantidad,String estadoeven)
				throws Exception {
			try {
				Evento r = new Evento();
				r.setNombre(nombre);
		...
		//Temporales
			public Evento crearEventoTmp(String nombre, String descripcion /*,
					String lugar*/, String imagen, Timestamp fecha_inicio, Timestamp fecha_fin, float costo, Integer cantidad)
							throws Exception {
		...
		//insertar tipo de evento
			...
			public void editarTipoEvento(Integer id_tevent, String tipo, String descripcion/*,Integer idcolor*/) throws Exception{
	 ...
	 // ------Salas-------
	 		...
	 		//insertar tipo de evento
	 			...
	 			//Modificar el tipoevento
	 			public void editarSala(Integer id_tevent, String tipo, String descripcion,Integer idcolor) throws Exception{
	 				Tipoevento te = TipoEventoByID(id_tevent);
	 				te.setTipo(tipo);
	 				te.setDescripcion(descripcion);
	 				ce= findcolorxid(idcolor);
	...
	// listar todas las inscripciones
		...
		public List<Inscripcione> findAllInscripcionesOrdenado() {
			return mDAO.findWhere(Inscripcione.class,"1=1", "o.fecha_inscripcion desc");
		}
