...
public class ManagerLogin implements Serializable{
	...
	public void insertarusuarios(String alias, String apellido, String correo,String nombre, String password, List<Tipologin> listadoLogin) throws Exception{
		...
		//Asignar ROLES
		for (Tipologin tipologin : listadoLogin) {
			this.insertarTipoUsr(usr, tipologin);
		}
	}
